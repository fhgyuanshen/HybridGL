...
class PhraseCutDataset(data.Dataset):
    def __init__(self, split='val', unseen_mode=False, seen_mode=False, preprocesser = None):
    ...
    def __getitem__(self, index):
        ...
        tensor_img = self.preprocesser(image)
        ...
        data = []
        data.append(dict(image=img,tensor_img=tensor_img, width=width, height=height, img_id=image_id, gt_masks=gt_masks, phrase=phrases, cat_name=img_ref_data['img_ins_cats']))
